  ...
  return (
    <Box w={"100%"} border={"1px solid grey"}>
       ...
       <Flex  borderRight={"1px solid #ccc"}> 
            ...
            <Box fontWeight={"600"} fontSize={"16px"} h="60px" w={"39%"} textAlign={"center"}>Blog Title</Box>
            <Box fontWeight={"600"} fontSize={"16px"} h="30px" w={"12%"}textAlign={"center"}>User Name</Box>
            <Box fontWeight={"600"} fontSize={"16px"} h="30px" w={"11%"} textAlign={"center"}>Status</Box>
            <Box fontWeight={"600"} fontSize={"16px"} h="30px" w={"8%"} textAlign={"center"}>View</Box>
            <Box fontWeight={"600"} fontSize={"16px"} h="30px" w={"10%"} textAlign={"center"}>Delete</Box>
        </Flex>
